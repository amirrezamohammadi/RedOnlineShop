    ...
    <div>
      <section className="w-full">
        ...
        <div className="flex flex-col items-center bg-red-50 py-20">
          ...
          <div
            className="w-4/5 mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8"
          >
            <div className="w-full shadow-md rounded-lg bg-white">
              ...
              <div className="p-4">
                <div className="w-full flex justify-between">
                  <h5 className="text-lg">T-shirt classNameic</h5>
                  <h6 className="text-lg">&#8356; 35</h6>
                </div>
                <h5>Black</h5>
                <a href="#">
                  <button
        ...
        <div id="features" className="flex flex-col items-center py-20">
          ...
          <div
            className="w-4/5 mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-1 lg:grid-cols-3 xl:gap-x-8"
          >
            <div className="w-full">
              <div
                className="bg-[#ff3333] h-14 w-14 flex items-center justify-center rounded-xl mb-4"
              >
              ...
              <a href="#" className="flex text-red-500 items-center">
                Discover More
                <i
                  className="fa fa-angle-right ml-2 text-xl text-red-500 no-underline"
                ></i>
              </a>
            </div>
            <div className="w-full">
              ...
              <a href="#" className="flex text-red-500 items-center">
                Discover More
                <i
                  className="fa fa-angle-right ml-2 text-4xl text-red-500 no-underline"
                ></i>
              </a>
            </div>
            <div className="w-full">
        ...
        <div className="flex flex-col items-center bg-red-50 py-20">
          ...
          <span className="border-t-0.5 border-solid border-[#ff3333] w-[30%]"></span>
          <div
            className="w-4/5 mt-8 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-1 xl:gap-x-8"
          >
            <button className="accordion flex items-center justify-between">
              <span className="flex flex-row items-center text-base font-medium"
                ><i className="material-icons text-[#ff3333] mr-2">info_outline</i>How
                can I place an order?</span
              >
            ...
            <div className="panel">
              <p className="py-4">
                ...
                American Express. Additionally, we also offer payment options like
                PayPal and Apple Pay for your convenience.
              </p>
            </div>
            <button className="accordion flex items-center justify-between">
              <span className="flex flex-row items-center text-base font-medium"
                ><i className="material-icons text-[#ff3333] mr-2">info_outline</i>How
                long does shipping take?</span
              >
              <i className="fa fa-angle-down text-2xl" ></i>
            </button>
            <div className="panel">
              <p className="py-4">
                ...
                dispatched within 1-3 business days. Once shipped, domestic orders
                usually arrive within 3-7 business days, while international
                orders may take 7-14 business days. Please note that these are
                estimated delivery times and actual delivery may vary.
              </p>
            </div>
            <button className="accordion flex items-center justify-between">
              <span className="flex flex-row items-center text-base font-medium"
                ><i className="material-icons text-[#ff3333] mr-2">info_outline</i>Do
                you offer international shipping?</span
              >
              <i className="fa fa-angle-down text-2xl"></i>
            </button>
            <div className="panel">
              <p className="py-4">
                ...
                imposed by your country. Please check our shipping policy for more
                details or contact our customer support team for specific
                inquiries.
              </p>
            </div>
            <button className="accordion flex items-center justify-between">
            ...
            <div className="panel">
              <p className="py-4">
                ...
                it for a refund or exchange. Please make sure the item is unused,
                in its original packaging, and accompanied by the receipt or proof
                of purchase. Certain items, such as perishable goods or
                personalized items, may not be eligible for return. For detailed
                information, please refer to our returns and refunds policy.
              </p>
            </div>
            <button className="accordion flex items-center justify-between">
              <span className="flex flex-row items-center text-base font-medium"
            ...
            <div className="panel">
              <p className="py-4">
                ...
                progress of your shipment on our website or the shipping carrier's
                website.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center py-20">
          ...
          <div className="w-4/5 mt-8 grid grid-cols-1 sm:grid-cols-1">
            <p className="text-center">
              ...
              odit error ut consectetur eos veniam blanditiis nemo quidem aperiam
              accusamus laboriosam, dolor tenetur dolores. Doloribus animi dolore
              incidunt illum illo.
            </p>
          </div>
          <div
            className="w-4/5 sm:w-4/5 lg:w-2/5 mt-6 grid sm:grid-cols-1 md:grid-cols-3 gap-2"
          >
            ...
            <button
              className="rounded-md bg-[#FF3333] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FF3333]"
            >
              Submit
            </button>
          </div>
